...
if __name__ == "__main__":
    ...
    y_smile_conv, y_emotion_conv, y_gender_conv, phase_train, keep_prob = NetModel.NetModelLayer(x)
    ...
    if not os.path.isfile(SAVE_FOLDER2 + 'model.ckpt.index'):
    ...
    for epoch in range(current_epoch + 1, NUM_EPOCHS):
        ...
        accuracy_train_result=(smile_train_accuracy+emotion_train_accuracy+gender_train_accuracy)/3
