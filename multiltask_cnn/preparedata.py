...
def PrepareSmileData():
    SMILE_LABEL_FOLDER = '/home/tinh/CNN/m_CNN/'
    SMILE_FOLDER = '/home/tinh/CNN/m_CNN/GENKI4K_GRAY/'
    F_SMILE_FOLDER = '/home/tinh/CNN/m_CNN/multiltask/database/'
    NUM_SMILE_IMAGE = 4000
    SMILE_SIZE = 48

    X = []
    with open(SMILE_LABEL_FOLDER + "labels_smile.txt") as f:
        for i in range(NUM_SMILE_IMAGE):
            fileName = SMILE_FOLDER + str(i) + ".jpg"
            print(fileName)
